...
macro_rules! define_filter_maps {
    ($prefix_map_name:ident) => {
        ...
        #[::aya_ebpf::macros::map]
        static EVENTS: ::aya_ebpf::maps::RingBuf =
            ::aya_ebpf::maps::RingBuf::with_byte_size(256 * 1024, 0);
        ...
        #[::aya_ebpf::macros::map]
        static $prefix_map_name: ::aya_ebpf::maps::HashMap<[u8; 128], u8> =
        ...
        #[::aya_ebpf::macros::map]
        static IGNORED_PATHS: ::aya_ebpf::maps::LruHashMap<[u8; 256], u8> =
        ...
        #[::aya_ebpf::macros::map]
        static FILTER_ENABLED: ::aya_ebpf::maps::HashMap<u32, u32> =
            ::aya_ebpf::maps::HashMap::with_max_entries(1, 0);
    };
}
